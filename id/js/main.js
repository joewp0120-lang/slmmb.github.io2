document.addEventListener('DOMContentLoaded', function() {
    ...
    (function() {
        ...
        whatsappLink.href = 'https://wa.me/8618027593021?text=Halo%20SLMMB%2C%20saya%20ingin%20sampel%20masterbatch%20gratis%20dan%20dukungan%20pencocokan%20warna%20untuk%20proyek%20plastik%20saya.';
        whatsappLink.className = 'whatsapp-float';
        whatsappLink.target = '_blank';
        whatsappLink.rel = 'noopener';
        whatsappLink.setAttribute('aria-label', 'Chat di WhatsApp');
        whatsappLink.innerHTML = '<i class="fab fa-whatsapp whatsapp-icon"></i>';

        var sampleLink = document.createElement('a');
        sampleLink.href = '/id/contact/?intent=sample';
        sampleLink.className = 'sample-float';
        sampleLink.setAttribute('aria-label', 'Minta Sampel Masterbatch Gratis & Uji Pencocokan Warna');
        sampleLink.innerHTML = '<i class="fas fa-gift me-2"></i><span class="sample-float-text">Minta Sampel Masterbatch Gratis & Uji Pencocokan Warna</span>';
